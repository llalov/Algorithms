...
namespace _8_2_Dijkstra.Tests
{
    ...
    public class DijkstraTests
    {
        ...
        {
            var path = DijkstraWithoutPriorityQueue.DijkstraAlgorithm(Graph, 0, 9);
            var length = 0;
        ...
        {
            var path = DijkstraWithoutPriorityQueue.DijkstraAlgorithm(Graph, 0, 2);
            var length = 0;
        ...
        {
            var path = DijkstraWithoutPriorityQueue.DijkstraAlgorithm(Graph, 0, 10);
        ...
        {
            var path = DijkstraWithoutPriorityQueue.DijkstraAlgorithm(Graph, 0, 11);
            var length = 0;
        ...
        {
            var path = DijkstraWithoutPriorityQueue.DijkstraAlgorithm(Graph, 0, 1);
            var length = 0;
